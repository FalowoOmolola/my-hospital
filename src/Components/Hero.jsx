    ...
    return (
        <div className="flex flex-col sm:flex-row items-center justify-between w-full px-4 sm:px-6 lg:px-15 py-5 lg:pb-10 gap-6 sm:gap-10">
            <div className="flex flex-col gap-3 w-full sm:w-1/2 max-w-xs sm:max-w-sm lg:max-w-xl">
                <p className="bg-[#14221f] text-white py-1 px-3 rounded-full text-[11px] sm:text-sm lg:text-base w-fit ml-20 sm:mx-0">
                    Medical Center
                </p>

                <h1 className="text-[#505457] font-semibold text-[20px] sm:text-lg lg:text-5xl xl:text-[40px] leading-snug sm:leading-tight text-center sm:text-left">
                ...
                <div className="flex flex-row sm:flex-row gap-2 sm:justify-start justify-center items-center text-[12px] sm:text-sm lg:text-base">
                    <button className="bg-[#14221f] w-25 sm:w-32 lg:w-40 py-1.5 lg:py-2 rounded text-white">
                        Appointment
                    </button>
                    <button className="border border-[#b6babb] w-25 sm:w-32 lg:w-40 py-1.5 lg:py-2 rounded text-[#636869]">
