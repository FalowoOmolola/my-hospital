    ...
    <div className="px-2 py-4 sm:px-18 sm:py-6 fade-in">
      <div className="flex lg:flex-row justify-between gap-6 mb-6">
        <div className="w-full lg:w-1/2">
          <h1 className="text-xl lg:text-3xl font-semibold text-[#161819]">
            How it Works
          </h1>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
        {[
          ...
          <div
            key={index}
            className="flex flex-col items-center justify-start text-center shadow-md bg-[#edf1f4] rounded-xl px-4 py-6 w-[160px] h-[240px] mx-auto"
          >
            <div className="bg-[#0c1e1c] text-white text-xl p-3 rounded-full border-[6px] border-[#1c3330] mb-8 mt-8">
              {step.icon}
            </div>
            <h5 className="text-sm sm:text-[20px] font-medium text-black">
